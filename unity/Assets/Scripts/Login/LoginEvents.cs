...
public class LoginEvents : MonoBehaviour
{
    ...
    private UnityEngine.XR.Interaction.Toolkit.Interactors.Visuals.XRInteractorLineVisual[] lineVisuals = new UnityEngine.XR.Interaction.Toolkit.Interactors.Visuals.XRInteractorLineVisual[2];

    // Start is called before the first frame update
    void Start()
    {
        // Find line visualizers.
        this.lineVisuals[0] = GameObject.Find("LeftHand Controller").GetComponentInChildren<UnityEngine.XR.Interaction.Toolkit.Interactors.Visuals.XRInteractorLineVisual>();
        this.lineVisuals[1] = GameObject.Find("RightHand Controller").GetComponentInChildren<UnityEngine.XR.Interaction.Toolkit.Interactors.Visuals.XRInteractorLineVisual>();
